...
// Selectors
import { selectOriginalAppointmentsDataLength } from '../_bus/Entities/EntitiesSelectors';
// Hooks
...
export const Dashboard: FC = (): JSX.Element => {
  ...
  const initAsyncAC = useCallback(
    () => fetchAppointmentsDataInitAsyncAC({ appointmentsDataLength, servicesDataLength, staffDataLength, customersDataLength }),
    [appointmentsDataLength, customersDataLength, servicesDataLength, staffDataLength]
  );
